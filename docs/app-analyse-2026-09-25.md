...
| **2 — Eine Kette** (v0.140–0.141) | ✅ **Teil 1 live v0.140.0 (26.09.2026):** R1 + Abschlusskette Screen → Service (§3 Zeile 1), T1/T5/T6 · Teil 2 (R7 Ferien) folgt als v0.141.0 | 1 Tag |
