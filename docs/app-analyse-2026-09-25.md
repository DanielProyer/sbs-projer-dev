...
|---|---|---|
| **1 — Sicherheit der Zahlen** (v0.139) | R2, R3, R4, R6, R11, Q1, Q3, Q5 (Regel 1100) → dann R9 klären | 2–3 Tage |
| **2 — Eine Kette** (v0.140–0.141) | R1 + Abschlusskette Screen → Service (§3 Zeile 1), R7 Ferien, T1/T5/T6 | 3–4 Tage |
