...
**B1 · Untere Navigationsleiste mit vier Zielen.** ✅ **v0.107.0 (16.09.2026)** — mit **Tour statt Büro**: Die Nutzungsmessung zeigte nach acht Tagen, dass Buchhaltung und Rechnungen ausschliesslich am PC geöffnet werden (20 Aufrufe, 0 vom Handy), der Tourenplan dagegen neunmal unterwegs. Ein Viertel der einhändigen Leiste hätte brachgelegen. Mit derselben Auslieferung fielen sieben Kacheln, die dieselben Ziele doppelten. Ursprünglicher Vorschlag: **Heute · Betriebe · Einsätze · Büro.** Von jedem Screen aus erreichbar, einhändig. Heute gibt es keine globale Navigation; jeder Weg ist push und pop, aus der Eingangsrechnung zurück zur Startseite sind es drei Mal «zurück». CanvasKit-sicher bauen (InkWell + Container, nicht `NavigationBar` — dreimal bestätigte Falle).

**B2 · Ein «Einsätze»-Screen für alle sechs Typen.** ✅ **v0.105.0 (15.09.2026)** — mit zwei Abweichungen: **fünf** Stufen (offen → geplant → in Arbeit → erledigt → verrechnet — «offen» ist die gemeldete Störung ohne Termin, die Daniel morgens sucht) und **keine Migration**: Der Status wird aus den vorhandenen Feldern abgeleitet (`einsatz_lage.dart`), weil die Tabellen ohnehin nur «fertig» kennen und die DB mit der v2 geteilt ist. Typ und Status als Mehrfach-Dropdowns statt Chips (360 px). Der Aufgaben-Screen bleibt vorerst eigenständig (→ B6). Die sechs alten Listen fallen mit v0.106.0 (Wächter). Ursprünglicher Vorschlag: Typ als Chip-Filter, Betrieb, Datum, Status; vier Stufen; Werte per Migration abbilden.

**B3 · Büro-Startseite = «Was ist offen?»** ✅ **v0.108.0 (16.09.2026)** — mit einer Unterscheidung, die der Vorschlag nicht hatte: **Frist oder Vorrat**. Was einen Stichtag hat, bleibt in der Glocke; ein Stapel ohne Stichtag (Bank-Prüfliste, offene Eingangsrechnungen, fehlende Buchungen, Versandvermerke) steht nur im Büro. Die Liste ist der Büro-Ausschnitt der einen Aufgabenliste aus B6, keine zweite. Abweichung bei den Gruppen: Lohn läuft monatlich und steht bei «Laufend». Ursprünglicher Vorschlag: Oben: unverbuchte Bank-Transaktionen, Eingangsrechnungen ohne Zahlung, Heineken-Rechnung Vormonat fehlt, Mahnungen fällig, MwSt-Quartal fällig — jede Zeile antippbar. Darunter die 13 Punkte in zwei Gruppen: **Laufend** (Bankauszug, Eingangsrechnungen, Forderungen, Heineken-Rechnung) und **Abschluss & Berichte** (der Rest).

**B4 · Monatsabschluss als geführte Checkliste.** ✅ **v0.109.0 (16.09.2026)** — zehn Regeln in vier Gruppen (Einsätze, Heineken, Bank, Lohn), Vorgabe Vormonat, jede Zeile mit Ampel und Sprungziel. **Kontrolle statt Ritual:** kein «Monat abgeschlossen»-Zustand in der DB — die Regeln lesen den Ist-Zustand. Der laufende Monat meldet bei Heineken, Lohn und Bank «Monat läuft noch» statt rot. Ursprünglicher Text: Dieselbe Idee wie die Abschlussprüfung (17 Regeln, jährlich), nur monatlich: alle Einsätze des Monats erledigt? Bergkundenpauschalen berechnet? Heineken-Rechnung erzeugt → gesendet → freigegeben? Bank importiert, Prüfliste leer? Genau der Fehlertyp «Kette bricht ab», der am 03./04.09. Ertragsbuchungen kostete, wird damit sichtbar, bevor er teuer wird.
