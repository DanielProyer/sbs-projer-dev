...
**Aktueller Stand (07.08.2026 spätabends):** ✅ Phase 1 komplett (28.07.). ✅ Phase 0 erledigt: frischer GKB-Export 12.03.–06.08.2026 gezogen und importiert. 🟢 **Phase 2 zu ~99 % durch (Nachhol-Import 07.08. abends, v0.72.13–17):** 370 camt-Buchungen, ALLE 28 Belastungen verbucht, Bank 1020 läuft wieder durchgehend bis 06.08. (DB-Saldo 1'990.79). **Restdifferenz zum E-Banking-Schlusssaldo 15'165.92 = exakt 13'175.13 noch nicht zugeordnete Gutschriften:** 2 Heineken-Gutschriften (7'104.98 + 5'794.81 → Feb/März-Monatsrechnungen, als Vorschlag bestätigen), 3 geparkte Kundenzahlungen in der Prüfliste (Ott-Ruf 74.60 · Schalter 74.60 · Schalter 138.35), Rest ~62 in «Nicht zugeordnet». Unterwegs gefunden+gefixt: Doppel-Tausch-Bug Bareinzahlung (2× Automaten-Einzahlung 8'050 verkehrt → DB korrigiert, Code v0.72.17); Allegra-Fehlgriff (5 Buchungen) rückgängig gemacht und neu zugeordnet. Rollback-Netz: Snapshot `snapshot_camt_abgleich` + `Datenbank/wartung/rollback_camt_abgleich_2026_08_07.sql` + App-Button «Zahlung rückgängig (Bankabgleich)».
