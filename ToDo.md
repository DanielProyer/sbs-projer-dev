...
- [ ] **Idee (aus dem Deploy-Zwischenfall 08.09.):** Deploy über ein eigenes `git worktree` statt Branch-Wechsel im Hauptverzeichnis — dann fasst er die Ablage nie an. Der Vorfall vom 11.08. (verlorene Churerfest-Koordinaten) wäre damit ausgeschlossen. ~30 Min.
