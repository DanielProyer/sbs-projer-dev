...
**Spec:** `docs/superpowers/specs/2026-07-31-betriebsdaten-aktuell-halten-design.md` · **Plan:** `docs/superpowers/plans/2026-07-31-betriebsdaten-aktuell-halten.md` (10 Tasks, wartet auf Startfreigabe). Kern: eigene Tabelle `betrieb_ferien` statt fünf fester Spaltenpaare (sonst verdrängen neue Ferien die Historie, aus der der Vorjahres-Hinweis stammt), Vorschlagstabelle statt stiller Übernahme, täglicher `pg_cron`-Lauf über je 10 Betriebe (`pg_cron` ist noch nicht aktiviert).
