...
- [x] **Drei Abweichungen umgestellt 08.09. (Freigabe Daniel):** Bellevue Flims Dorf → false (David-System), Gspan Arosa → true, Weiss Kreuz Preda → true (beide konventionelle Anlage). Begründung je in den Notizen des Betriebs. Namensdoppel beachtet — «Bellevue» gibt es dreimal (Bad Ragaz, Davos, Flims Dorf), «Weiss Kreuz» zweimal (Preda, Splügen); geändert wurde über die IDs. **Gegenprobe: kein Betrieb mit false hat mehr eine erfasste Anlage**, und der einzige verbleibende Ausreisser ist Badus selbst (Anlage noch nicht erfasst).
