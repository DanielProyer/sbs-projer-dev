...
5. **Internet-Recherche zu den 53 offenen Fällen (3 Agenten, Zefix/Impressen/News): 49 aufgeklärt → 52 weitere Aliase auf 42 Betriebe** (Belege im Doc). Korrekturen: Alpenblick-Arosa-Alias entfernt (gehört Weggis), Lenzerhorn-Alias entfernt (Hotel betreibt auch Spescha → Zwei-Betriebe-Zahler). Bewusst OHNE Alias: HR Seehof (Seehof+Chesa), M&M Gastro (Giodavin+Ochsen), Allegra Vinum (Franziskaner+Fondue Beizli), Traube Senti (Alt-Wirt Don Camillo). **AlpinTrend-Gruppe (Bergamin) erklärt 5 Zahler.** Offen nur noch 4 Fragen (BARacca/Pagels, Weissfluhgipfel/Racine, Weissfluhjoch/Surselva Hospitality, Don-Camillo-Blazevic-Alias). **Bestand: 120 Betriebe / 132 Aliase** (vor heute 25). Kenntnisnahme: Löwen Sins seit ~04/2026 neuer Betreiber (Peterhans).
