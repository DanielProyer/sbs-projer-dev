...
- [x] ~~**Entscheid Staging-Lauf**~~ **Daniel hat am 29.08. direkt zugestimmt** (an die Heineken-Session, vor Montag). Sie lesen die 731 per `uebernahme_lesen` ins Staging — rein lesend, bei Google ändert sich nichts. Zweck: der Umzug wird prüfbar, und es entsteht die **einzige zweite Kopie** (die Alt-App kennt diese Kontakte nicht). **Die gemeldete Staging-Zahl ist unsere Vorher-Grösse für den Umzug** — sie kommt von Heineken, noch ausstehend.
