...
- [ ] **① Kontakte-Umzug** (Voraussetzung für ③): geschäftliche Kontakte dani.proyer@ → sbs.projer@. **Vorher klären:** Woran erkennt man geschäftliche Kontakte (Label? Abgleich gegen `betriebe`? manuell) — und erst **zählen**, wie viele in beiden Konten liegen und wie stark sie sich überschneiden.
