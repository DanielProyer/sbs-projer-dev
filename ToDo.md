...
- [ ] **Später (auf Zuruf):** Entflechtung «1 Client = 1 Verwendung» — Client ① trägt weiterhin zwei Verwendungen (SBS-Kalender + Heineken-Gmail), Client ② ebenfalls (Finanzapp- + Heineken-Kontakte). Genau diese Bauart hat den Ausfall vom 27.08. verursacht; sie ist jetzt dokumentiert, aber nicht beseitigt.
