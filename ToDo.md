...
- [ ] **🔵 Vor dem Umzug klären (Daniel):** (1) **Welche Gruppen ziehen um?** Gruppe für Gruppe entscheiden — «SBS App» klingt nach App-Bestand, «SIM» und «SBS Event» sind ungeprüft. (2) **Wie viele Personen sind das?** 440 sind Mitgliedschaften, ein Kontakt kann in mehreren Gruppen stehen. (3) **Was ist mit den ~237 Kontakten in gar keiner Gruppe?** 768 im Konto, 531 Mitgliedschaften, Differenz 237 — für diesen Rest gäbe es **keine** Zuordnung geschäftlich/privat. Stichprobe auf Firmen-Mailadressen/Firmennamen. ⚠️ Die 237 ist noch **nicht gemessen**: Mehrfachnennungen könnten sie vergrössern, und drei Gruppen meldeten gar keine Mitgliederzahl (die API lässt `memberCount` bei 0 weg — Annahme, kein Beleg). Vor einer Entscheidung messen.
