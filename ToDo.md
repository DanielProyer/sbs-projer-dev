...
- [ ] **🔵 Vor dem Umzug klären (Daniel):** (1) ~~**Welche Gruppen ziehen um?**~~ **ENTSCHIEDEN 01.09.: alle 5 klar geschäftlichen Gruppen ziehen um** (SBS App, Geschäftlich, SBS Kunden, SBS Heineken, Gampel 2026); «SBS Event» und «SIM» entscheidet Daniel nach Sicht der Mitgliederlisten. (2) **Wie viele Personen sind das?** 440 sind Mitgliedschaften, ein Kontakt kann in mehreren Gruppen stehen. (3) **Was ist mit den ~237 Kontakten in gar keiner Gruppe?** 768 im Konto, 531 Mitgliedschaften, Differenz 237 — für diesen Rest gäbe es **keine** Zuordnung geschäftlich/privat. Stichprobe auf Firmen-Mailadressen/Firmennamen. ⚠️ Die 237 ist noch **nicht gemessen**: Mehrfachnennungen könnten sie vergrössern, und drei Gruppen meldeten gar keine Mitgliederzahl (die API lässt `memberCount` bei 0 weg — Annahme, kein Beleg). **Messungen (2)+(3) + Mitgliederlisten SBS Event/SIM am 01.09. ~16:15 bei der Heineken-Session angefragt** (rein lesend via kontakte-google); Zusage: voraussichtlich noch am Abend des 01.09., nach deren Feldtag-Abendprogramm.
