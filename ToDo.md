...
- [x] ✓ **Phase 1 (live v0.45.0 · 11.07.2026):** Neuer Screen `/buchhaltung/auswertung` — Umsatz/Arbeiten nach Jahr+Monat, 3 Modi (Jahr / Jahre / **Monatsvergleich über Jahre**), Charts (`fl_chart`, grün dezent), **netto/brutto umschaltbar**, professionelle Tabelle (Monat·Anzahl·Kunde·Heineken·Total, Zeile aufklappbar → Kategorien). Rein **live** aus App-Daten (Reinigung volle Historie 2019+, übrige Kategorien + Heineken-Split ab Dez 2025). Kunde/Heineken-Split via `betrieb.rechnungsstellung=='heineken'`. Reines Aggregat TDD (9 Tests), adversariale Review (5 Low-Funde gefixt: nice Y-Achse, _expand-Reset, monateVon-Cache). **🟡 Offen (User):** Live-Zahlen gegen Excel abgleichen (v.a. ein 2026-Monat wo alle Daten da sind).
