...
4. **Entflechtung ab KW 36 — GESTARTET 01.09.** (Plan: `Datenbank/oauth-entflechtung-plan.md`): Entscheid 1 gefällt (alle 5 geschäftlichen Gruppen ziehen um), Messungen für Entscheide 2+3 bei der Heineken-Session angefragt (Zusage: Abend 01.09.), dann Heineken-Projekt, dann Kalender — **Absprache mit den Sessions Heineken + Finanzapp ist Pflicht** (Memory: projektuebergreifend-absprechen)
