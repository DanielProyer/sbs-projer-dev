...
- [ ] **Drei Abweichungen zur Entscheidung** (nichts geändert): **Bellevue, Flims Dorf** steht auf true, hat nur David-Störungen und keine Anlage → vermutlich false. **Gspan, Arosa** (false, Buffetanstich-Anlage, 14 Reinigungen, letzte 2021) und **Weiss Kreuz, Preda** (false, Warmanstich-Anlage, Reinigung 26.05.2026) → vermutlich true.
