...
- [ ] **Rest-Handgriffe im Dashboard (Daniel, unkritisch):** die drei stillgelegten `google-secret-probe`-Functions endgültig löschen — SBS `pltbaqqwpnmdajwgnhpd`, Heineken `dtdcohqjihoiqlaekeiz`, Finanzapp `botsyitkcxxkwpslsssq`, je Edge Functions → google-secret-probe. Antworten aktuell mit 410 und Erklärungstext, also harmlos.
