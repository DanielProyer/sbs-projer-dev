...
- [ ] **① Kontakte-Umzug** (Voraussetzung für den ganzen Umbau, nicht nur ③): geschäftliche Kontakte dani.proyer@ → sbs.projer@. `konto=dani` ist Heinekens **Lesequelle**, nicht bloss ein Regelbruch — Abklemmen erst, wenn die Kontakte im Geschäftskonto liegen. 🔴 **Die Gruppe «Geschäftlich» hat 88 Mitglieder, nicht 731** (Staging-Lauf 29.08.: 88 gelesen, 88 gespeichert, fehlerfrei). Die 731 stand in Heinekens Function und Anleitung, war aber **nie die Gruppengrösse** — vermutlich die Gesamtzahl der Kontakte im Konto, unbelegt. **Vorher-Zahl für den Umzug ist damit 88.**
- [ ] **🔵 Vor dem Umzug klären (Daniel):** (1) Wie viele Kontakte hat das Konto dani.proyer@ insgesamt? Das bestätigt oder widerlegt die 731-Vermutung. (2) Stichprobe: Kontakte mit Firmen-Mailadresse oder Firmennamen **ausserhalb** der Gruppe. Die Frage ist nicht mehr «ist die Gruppe vollständig», sondern **was mit den übrigen Kontakten ist** — bei 88 von möglicherweise 731 bedeutet «die geschäftlichen umziehen» je nach Antwort etwas völlig anderes. Erst danach festlegen, was umzieht.
