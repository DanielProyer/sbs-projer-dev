...
class CamtDateienTab extends ConsumerWidget {
  const CamtDateienTab({super.key});
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(
              'Lücke: ${CamtDateienTab._fmt(von)} – ${CamtDateienTab._fmt(bis)}',
          ...
          children: [
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    '${CamtDateienTab._fmt(datei.zeitraumVon)} – '
                    '${CamtDateienTab._fmt(datei.zeitraumBis)}',
                    style: const TextStyle(
