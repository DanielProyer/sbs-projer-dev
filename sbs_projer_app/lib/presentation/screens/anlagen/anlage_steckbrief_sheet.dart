  ...
  Future<void> _senden() async {
    ...
    if (_scharf && !ziel.contains('@')) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Bitte eine gültige RSL-Adresse eingeben.'),
        ),
      );
      return;
    }
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            '${widget.betriebName} — ${widget.anlageBezeichnung}',
          ...
          if (widget.rslMail == null || widget.rslMail!.isEmpty)
            const Padding(
              ...
              child: Text(
                'Kein RSL hinterlegt — in „Heineken-Zuweisungen" festlegen oder unten eintragen.',
