...
///
/// Neu kalibriert am 30.07.2026, nachdem die echten Uhrzeiten aus dem Excel
/// nachgetragen wurden: Median von beobachtet/Luftlinien-Fahrzeit = 2.53 über
/// 2'434 Paare (vorher 2.15 über nur 180, teils aus fehlerhaften
/// 1-Minuten-Zeiten). Der Wert liegt bewusst über einem reinen
/// Strassen-Umwegfaktor (~1.6), weil die beobachtete Lücke auch Parkieren
/// und Ein-/Ausladen enthält — genau diese effektive Übergangszeit soll der
/// Tagesplan abbilden.
const double kFahrzeitFaktor = 2.5;

/// Angenommene Durchschnittsgeschwindigkeit (Berggebiet, Ortsdurchfahrten).
const double kSchnittKmh = 45.0;

int heuristikMinuten({
  required double luftlinieKm,
  double faktor = kFahrzeitFaktor,
}) {
