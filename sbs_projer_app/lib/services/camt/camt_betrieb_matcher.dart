...
class CamtBetriebMatcher {
  ...
  ///
  /// Es zählt NUR `heineken_nr` — die eigene Betriebsnummer, DB-weit eindeutig
  /// und die einzige Nummer, die auf den Rechnungen steht (Fix 07.08.2026).
  /// WE-/AG-Nummern stehen nie auf Rechnungen (der Betrieb kennt sie nicht)
  /// und die Hausnummer `nr` identifiziert keinen Betrieb — beide erzeugten
  /// nur Schein-Mehrdeutigkeiten (185 Kollisionen), durch die das Routing der
  /// Sammelzahler auf den unscharfen Namens-Match zurückfiel.
