...
void main() {
  test('MwSt-pflichtig: EINE Zeile — Vorsteuer läuft über mwst_konto (B1-Fix)', () {
    // Die frühere zweite Zeile (Vorsteuer an Aufwand) verdoppelte die
    // Vorsteuer: die SaldoExpansion teilt die Hauptzeile über mwst_konto
    // bereits korrekt auf (Soll netto / Vorsteuer mwst / Haben brutto).
