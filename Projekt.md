...
**Version**: 0.56.2+632 (v0.56.1: vergangene Tage zeigen die gemessenen Ist-Zeiten statt einer Plan-Rechnung ab 06:00 — Fall «Plan vom 17.07.»; v0.56.2: Betriebsseite aus dem Block-Sheet verlinkt, fällige Geschwister-Anlagen bei Plan-Übernahme/Bulk ergänzt — Sunset-Fall, Arbeitstag-Fehleingaben-Schutz mit Bestätigung + editierbarem 4-Felder-Sheet; v0.56.3: Startbildschirm kompakt — Arbeitstag einzeilig, Übersicht enger, flachere Kacheln, alles ohne Scrollen aufs Pixel 9)
