...
**Version**: 0.99.4 (**STEUERN, DOKUMENTE & ABSCHLUSSPRÜFUNG + BETRIEBSDATEN-WERKZEUGE** [v0.96.0–v0.99.4, 10 Deploys, Migrationen 181–187]: **Steuern-Screen** unter Buchhaltung — Jahreskarten 2019 ff. mit Ampel [Soll aus Veranlagung gegen bezahlt aus `view_steuerjahr_zahlungen`], Jahresdetail mit Dossier-Checkliste, Tabellen `steuerjahre` + `buchungen.steuerjahr/steuerart`; **Dokumente-Modul** [Bucket + Tabelle `dokumente`, sechs Bereiche, Filter, Upload ≤20 MB] mit **76 importierten Steuerdokumenten 2019–2025** [Skript `import_steuer_dokumente.py`, dazu 7 Steuerjahre und 63 Zahlungszuordnungen — **0 Steuerbuchungen ohne Jahr**]; **Abschlussprüfung ersetzt den alten Audit-Screen** [16 Regeln mit Jahreswahl, rot/gelb/grün, Tap → Zielscreen]; **camt-Import kontiert Steuerzahlungen selbst** [2208 solange die Rückstellung des Jahres offen ist, sonst 8900, MWST 2202; Restsaldo wird innerhalb eines Imports fortgeschrieben]. Alle 15 Plan-Tasks subagent-driven mit je Spec- und Quality-Review; das Gesamt-Review fand einen **Sicherheitsbefund**: `view_steuerjahr_zahlungen` lief als SECURITY DEFINER an der RLS vorbei und war mit dem anon-Key ohne Login lesbar → **Migration 185**. **Buchungs-Nachholung** [v0.97.0]: Am 03./04.09. blieben zwei abgeschlossene Reinigungen ohne Ertragsbuchung, weil die Abschluss-Kette im Browser abbrach — die App holt sie jetzt nach [automatisch nach jedem Abschluss, 14 Tage, Timeout 20 s; auf Knopfdruck mit Vorschau; **nie rückwirkend in ein abgeschlossenes Geschäftsjahr**]. Dabei gefunden: Die Warnung «Reinigungen ohne Rechnung» schnitt seit Kurzem stumm bei 1000 Zeilen ab [1022 im Fenster] → paginiert, neuer Wächtertest. **Betriebsdaten** [v0.97.1–v0.99.3]: Saison-Termine im Tourenplan einklappbar; **keine vergangenen Saison-/Ferien-Termine mehr im Kalender-Dialog** [Acla Grischuna bot am 08.09. die Wintersaison 13.12.2025–29.03.2026 an]; **Saison-Historie** [Migration 186 — ein abgelaufenes Fenster wandert ins Archiv, sobald sich das Startdatum ändert; bewusst NICHT aus den 345 Endreinigungen abgeleitet, weil eine Endreinigung auch mitten in der Zwischensaison liegen kann]; **Servicezeiten-Durchsicht** [Migration 187 — Betrieb für Betrieb durchwischen, Vorschlag aus den Besuchen seit 2019 mit p10/p90 und 15-Minuten-Rundung, Öffnungszeiten und Besuchsliste auf der Karte; **201 der 305 aktiven Betriebe hatten gar keine Servicezeit**]. **Buchhaltung**: Scheibenwischwasser gehört auf 6200 statt 4004 [`parse-beleg` v40, alle 35 Vergleichsbuchungen seit 2019 liegen auf 6200]; **12 MWST-Saldierungen mit Datum 2025 trugen Geschäftsjahr 2026** [Handlauf vom 01.09.; korrigiert, dazu die 16. Regel «Geschäftsjahr passt zum Datum»])
