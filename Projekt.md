...
**Version**: 0.95.0 (**BUCHHALTUNGS-GROSSTAG 01.09. + OAUTH-KOMPLETT-RESET 29.08.** [v0.93.0–v0.95.0, 4 Deploys, Migrationen 179+180]: **MWST KOMPLETT** — Q1+Q2/2026 eingereicht [Zahllasten 3'885.01/2'293.00, Zahlungen ausgelöst] plus Berichtigung 2025 als **vier Korrektur-Quartalsabrechnungen** [das Portal kennt keine Jahresabstimmung; Nachzahlungen 244.49/260.43/352.61/651.09 = rappengenau 1'508.62, ESTV schickt Rechnung per Post], alle sechs Portal-PDFs gegen das Journal verifiziert — der 2025er-Netto-statt-Brutto-Fehler ist vollständig bereinigt; **Saldierung Q1/25–Q2/26 gebucht** [18 Zeilen nach 2024er-Muster, 2202 zeigt erstmals seit 20 Monaten wieder die echte offene MWST-Schuld +7'234.63, Altlast −450.61 ausgewiesen → Aufsetzkorrektur]; dabei **Franchise-Januar-Loch gefunden und beleggestützt nachgebucht** [Monats-Abgrenzungen endeten 31.12.25, die Zahlung 09.03. tilgte Kreditor 2000 ohne Aufbau — Aufwand fehlte ganz, VSt 282.69 wäre verfallen; Kreditor 2000 von −3'675.75 auf +96.95; alle Franchise-Belege Jan–Aug gescannt und mit den Buchungen verknüpft, Zahldaten per Handvermerk gemessen statt abgeleitet]. **KREDITOREN-MODUL IN BETRIEB** — Befund: seit Ende Juni fertig validiert [pain001 von GKB akzeptiert, End-zu-End synthetisch], die 23 «verworfenen» waren Testdaten; Echtstart mit Franchise Juli+August als Stufe-1-Eingangsrechnungen; **camt-August TX-genau** [58 TX, Bank 1020 per 31.08. = 23'351.23 = CLBD auf den Rappen; Heineken-Juli-Monatsrechnung 10'102.16 bezahlt = Fahrplan-Schritt 5a erledigt; Lohn 3'500 auf 2002]; **Befund GKB spielt QRR/SCOR-Referenzen im camt zurück** [Gutschriften UND Belastungen — Mehrfachzahler wie Weisse Arena ×4, Davos Klosters ×5, Lenzerhorn ×2 matchen deterministisch per QR-Referenz; die offene Empirie-Frage vom Juni ist beantwortet]; ein 32er-Rollback auf Daniels Wunsch [Snapshot, Rückabwicklung nach App-Logik, Neu-Verbuchung — alle korrekt]. **v0.95.0 BANK-WÄCHTER** — Lückenlos-Prüfung beim Import [OPBD vs. Journal per Vortag, VOR jeder Buchung; Exportzeitpunkt damit egal] + Dauer-Karte im Buchhaltungs-Dashboard [Journal vs. letzter Bank-Schlusssaldo + «Tilgung ohne Aufbau»-Warnungen auf 2000/2002/2202/227x — hätte Franchise-Januar UND Lohn-August sofort gezeigt; visuell bestätigt]; Lohn-Prozess für unregelmässige Zahlungen: Wächter zeigt den 2002-Soll = Netto für den nächsten Lohnlauf. **v0.94.0 EISSÄULE** [Feldfund Padelta Chur: Dekorsäule mit Eismantel, kein Kühler — neues Feld + Hinweise «vor Reinigung ausschalten / danach einschalten» beim Beginn UND im Abschlussdialog, gilt auch für den Booster, der bisher nirgends im Ablauf auftauchte; Migration 179]; **v0.94.1 Rechnungs-PDF** [Upload brach nach 54 ms ab (ABORTED im Storage-Log) — Rechnung+Buchung standen, PDF und uebergeben_am fehlten, und der Nachholweg hätte das PDF NIE erzeugt, aber Erfolg gemeldet; neu: RechnungNachholPlan prüft am Storage statt an pdf_url, PDF-Ablage wirft nicht mehr, fehlendes PDF wird benannt]; **v0.94.2 Fortschrittsdialog** [«12 von 32 …» statt 10 stummer Sekunden bei «Alle verbuchen»]; **v0.93.0 Tourenplan-Refresh** [29.08.: Pull-to-Refresh + PC-Knopf — Web lud alle Daten nur beim App-Start, tagelang offene Tabs zeigten Gereinigtes als überfällig]. **OAUTH-KOMPLETT-RESET 29.08.** [3 Google-Clients, alle Secrets F/E/G + alle Tokens neu, koordiniert über 3 parallele Claude-Sessions, jeder Schritt gemessen — 4 plausible Ableitungen zerbrachen an Messungen; Projekt ③ gehört sbs.projer@; Endbild je Client 1 Secret mit PM-Konsumenten-Liste; Entflechtungsplan «1 Client = 1 Verwendung» + Trennung geschäftlich/privat freigegeben, ab KW 36: Kontakte-Umzug (5 Gruppen ~440 Mitgliedschaften, nicht nur «Geschäftlich» 88) → Heineken-Projekt → Kalender-Umzug] · **1212 Tests grün**) — zuvor 0.92.2 (**Mail-Versandvermerk serverseitig** [App v0.92.2 + Edge Function `send-rechnung-mail` v15, 27.08.]: Rechnung 2026-08-1382 an Hugos Davos ging morgens **erfolgreich** raus — Gmail `messageId 1a04214d1b441975`, HTTP 200, beide PDFs —, die App zeigte trotzdem einen Fehler und liess `versendet_am` leer. Ursache: Der Vermerk hing am Code **nach** dem `invoke()`; geht die Antwort verloren [Timeout, Verbindungsabbruch], ist die Mail beim Kunden und der Status bleibt «offen» — ein zweiter Klick hätte sie erneut verschickt. Zeitbeleg: Rechnung zuletzt 07:17:33.4 angefasst, Versand erst 07:17:36.0 fertig; bei Jodys am selben Vormittag kam das Update 74 ms **nach** dem Versand. **Neu setzt die Function den Vermerk selbst** [Parameter `markiereVersandt`]: `versendet_am` immer, `zahlungsstatus` **nur** `offen`→`gesendet` via PostgREST-Filter — Mahnstufen und «bezahlt» bleiben stehen, Mahnungen sind ganz ausgenommen; `markiereRechnungVersandt()` wirft **nie**, weil die Mail zu dem Zeitpunkt schon raus ist. Betroffen waren nur **3 der 5** Aufrufstellen [Material-Bestellung schreibt in eine andere Tabelle, Montage-/Reinigungs-Rapporte haben keinen Rechnungsbezug]. Filterlogik gegen den Echtbestand geprüft, Gmail-Versandweg per Testmail bestätigt. **Zugangsdaten-Audit:** `GMAIL_*` liegen ausschliesslich in den Supabase-Secrets, keine Werte im Repo oder in der Git-Historie — aber **kein Backup**, der Refresh-Token ist nicht wiederbeschaffbar [Merkposten in ToDo.md]. `CLAUDE.md` richtiggestellt: die dort genannte Root-`.env` existiert nicht · **1182 Tests grün**) — zuvor 0.92.1 (**NACH DER EVENT-WOCHE 15.–26.08.** [v0.86–v0.92.1, 6 Deploys + Sicherheitsarbeit]: **Anlass-Montagen waren NIE speicherbar** v0.90.1 — der Anlass-Fluss schreibt Freitext-Tageszeilen in `material_1_id..5`, die Spalten waren `uuid` → Fehler 22P02 bei jedem Speichern [Migration 175 auf `text`, dazu UUID-Filter im Material-Lookup]; **Karten-Ebenen** v0.90.0 — Lageplan/Stände/Anstiche/Kühler einzeln schaltbar, das Panel zeigt nur, was Daten hat, und die Stände-Ebene ist im Positionier-Modus gesperrt [sonst «platziert, aber blind»]; **Karte ↔ Stand** v0.89.0 — «Karte»-Knopf springt gezoomt auf den Stand, Marker-Farben nach Baufortschritt statt Datenqualität [rot = Hollandbuffet noch nicht in Betrieb wegen 2–4 h Vorlauf, blau = offen, grün = fertig]; **FAB verdeckte den Standort-Knopf** v0.90.2 — der Scaffold-FAB belegt die unteren 72 px, der Karten-Knopf stand auf `bottom: 34` [Feldfund Daniel, jetzt Stapel über benanntem `_fabFreiraum`]; **Sync meldete Teilfehler nicht** v0.91.0 — `_pushToSupabase` fing Fehler pro Satz ab und schrieb sie nur in `debugPrint`, `SyncResult.errors` blieb leer und die App meldete Erfolg, während Sätze auf dem Server fehlten; beim Fixen zeigte sich, dass **kein einziger** Aufrufer das Ergebnis auswertete und `SyncState.error` von **keinem** Widget gelesen wurde [neu `pushEinzeln()` + `syncMeldung()`, «Sync erzwingen» meldet das Ergebnis, Indikator zeigt Fehler]; dazu die tote Leitungs-Kopie nach Stand-Löschung [`ON DELETE SET NULL` serverseitig, lokal nicht nachgezogen — hätte dem Pikett ein Ziel genannt, das es nicht mehr gibt]; **Arbeitszeit schlägt Abrechnungsstunden vor** v0.92.0/1 — die gemessene Zeit füllt `dauerStunden` auf Viertelstunden aufgerundet, aber **nur wenn das Feld leer ist**; ein eingetragener Wert bleibt unangetastet [Regel Daniel: das Feld enthält bewusst Anfahrtsanteile]; ein Test fand dabei die Fliesskomma-Falle `0.7500000000000001 / 0.25 = 3.0000000000000004` → `ceil()` hätte **1.00 h statt 0.75 h** ins Geldfeld geschrieben; **Sicherheitsvorfall 23./26.08.** — Supabase meldete `snapshot_gampel_testdaten` ohne RLS, sieben Tage mit dem anon-Key aus dem Web-Bundle les- **und schreibbar**; Log-Prüfung über rund 4900 Zugriffe ergab **null** Zugriffe darauf, danach alle vier Snapshot-Tabellen + Reset-Funktion entfernt [Migrationen 176–178], `search_path` aller 20 Trigger-Funktionen fixiert und der RLS-Auto-Trigger `ensure_rls` eingeschaltet, der den Fehlertyp künftig unmöglich macht — zweimal praktisch nachgewiesen · **1182 Tests grün**) — zuvor 0.85.0 (**EVENT-WOCHE 10.–14.08. — Churerfest + Openair Gampel** [v0.75–v0.85, 13 Deploys]: **Lageplan-Georeferenzierung** v0.83.0–2 — JPG des Festgeländes mit 2–5 Passpunkten aufs Luftbild legen [Migration 170, Mathe `georeferenz.dart`: 2 Punkte Helmert, ab 3 affin, Residuen in Metern; Bucket liess nur PDFs zu → Migration 171; Speichern-Knopf war CanvasKit-tot; «Lageplan entfernen» nachgereicht], **Stände am PC positionieren** v0.77.0 [Tap auf Karte, Marker nach Herkunft, Vorjahres-Übernahme endlich angebunden inkl. inBetrieb-Reset-Fix] + **Koordinaten-Direkteingabe** v0.78.0 [Google-Maps-Formate, Warnung bei vertauschter Breite und Länge, Genauigkeitsstufe genau·mittel·ungefähr Migration 169, bei GPS automatisch aus der Messgenauigkeit] + **GPS-Abgleich im Feld** [nie stilles Überschreiben — Dialog mit Luftbild, beiden Punkten und Distanz], GPS-Stufe auf bestForNavigation; **Stand-Übersicht** v0.80–v0.84.1 in 5 Iterationen [Nummern-Badge, Standort-Kennung, Tel-und-WhatsApp-Direktwahl, Ansprechpartner aus Notiz; dabei **CanvasKit-Renderfehler Nr. 3: ExpansionTile mit dense=true zeichnet title und subtitle nicht** — 3 Blind-Deploys, gelöst erst per Screenshot; Regel + Wächter-Test `canvaskit_sichere_widgets_test.dart` + CLAUDE.md-Block «bei ‹sehe X nicht› zuerst Screenshot»]; **Montage generieren mit Details** v0.85.0 [Slots tragen Kategorie und Notiz je Tag: «Mi 22.7. — Anfahrt 1h · Inbetriebnahme 2h (Augenschein)», Heineken-Rapport-Tabelle wächst mit statt abzuschneiden]; **Rechnungsadresse mehrzeilig** v0.75.0 [Fall SV (Schweiz) AG / Spiga: Objekt, Kostenstelle, Zusatz, Postfach — Migration 167, nachname-Altlast aufgelöst, QR-Zahlteil bleibt normkonform, Adressblock aus 3 PDF-Services in eine Funktion gezogen; Rechnung 2026-07-1007 korrekt neu versendet]; **Feierabend- und Einsatz-Fixes** v0.76.0 [GPS blockierte das Speichern am PC → erst speichern, dann Standort + Startort-Fallback Domat/Ems + Zeitlimits auf allen Geolocator-Vorabfragen; Einsatz liess sich nie abschliessen (Fall Sartons, 8 Tage im Tourenplan) → «Beenden»-Knopf + Regel Arbeitsende=erledigt für Montage UND Störung; anlage_id "" statt null (Fall Cocktail Bar)]; **Materialbestellung: freie Auswahl über alle Artikel** v0.79.0. Daten und Betrieb: Winter-Saisonstarts 2026/27 für 8 Betriebe per 2-Agenten-Recherche gesetzt [Jakobshorn 27.11. · 04.12. · Milez 12.12. offiziell · 19.12.], Steakhouse Ochsen = Ganzjahresbetrieb; Arbeitstage 07.+11.08. nachgetragen und bestätigt; Churerfest: 17 Stände mit Koordinaten und Genauigkeit; Gampel-Lageplan referenziert. **Fahrplan Grossvorhaben 6/7/8** nach 3-Agenten-Kartierung: Kalender-Tourenplan-Anbindung am 14.08. bewusst VERWORFEN [Iststand mit 6 Push-Typen deckt den Bedarf], Historik-Kern ist FERTIG [14'552 Journal-Zeilen, Treue-Gates PASS; Restposten im Buchhaltungs-Fahrplan: EK-Vortrag 35'319.11 fehlt, Kreditoren-Modul seit 08.06. ungenutzt], Projekt Heineken läuft als eigenes Repo unter D:\Projekte\Heineken [ADRs beschlossen, RLS-Bauplan freigegeben]) (zuvor 0.74.0: **KRITISCHER PAGINATION-FIX + LOHNBLOCK KOMPLETT 08.08.** — die Bilanz zeigte bei jedem Neuladen zufällig andere Zahlen, weil 9 paginierte Abfragen nur nach `datum` sortierten [1'874 Tage tragen mehrere Buchungen]; `.order('id')` als eindeutiger Schlüssel + Wächter-Test `pagination_stabil_test.dart`. Dazu Lohnblock: Nachhol-Lohnläufe April–Juli, 2026er-Normalisierung, Salden-Umgliederung 2270–2273, **Lohnausweis 2025 erstellt** im amtlichen Formular-11-Layout, **PDF-Sonderzeichen endgültig gelöst** [Roboto-Unicode via `pdfDokument()`-Factory in 17 Services + Wächter-Test]. Analysen: Kassenabgleich, Lohnabgleich 2019–2026, **SVA-Originalbelege vollständig ausgewertet**, MWST-Saldierungslücke seit Q1/2025 aufgedeckt) (zuvor 0.73.1+673: **NACHHOL-IMPORT KOMPLETT 07./08.08.** — GKB-camt 12.03.–06.08. vollständig verbucht, Bank 1020 stimmt transaktionsgenau mit dem E-Banking überein [14'952.97 + 2 offene Schaltereinzahlungen = 15'165.92]; Abgleich-Werkzeuge in 8 Iterationen gehärtet v0.72.11–18: Sammelzahler routen NUR via Vermerk-Betriebs-/Rechnungsnummer, Paar-Badges, «Später klären»-Parkliste, «Zahlung rückgängig (Bankabgleich)», Rollback-Snapshot; 3 Buchungsfehler gefunden+behoben [Doppel-Tausch Bareinzahlung 8'050, Sammelzahlungs-Differenz +12.20, Heineken-Rappen]; Heineken Feb+März-Zahlungseingänge nachgebucht; dazu v0.73.0/1: **Kontoauszug-PDF pro Betrieb** [Mahn-Gespräche, Sonderzeichen-sicher], **Service-Hinweis** am Betrieb [Kulanz-Band im Abschluss-Dialog, gesetzt bei Chleina Pub], **Forderungen-Screen umgebaut** [Offene zuoberst, 3 Filter nebeneinander inkl. «Alle Jahre», klare Trennung]) (zuvor 0.72.10: Buchhaltungs-Fahrplan Schritte 1–3 erledigt: Heineken-Rundung v0.72.5, Storno-Reparatur v0.72.6 + Migration 166, MwSt-Doppelbuchung behoben v0.72.7 inkl. Bereinigung von 977 Trennbuchungen per Snapshot-Migration, camt-Stichtag/Richtung v0.72.8; camt-Import-Gesamtprüfung mit Härtung v0.72.9; Sammelzahler + Zahlernamen-Lernen v0.72.10 — 135 Zahler-Aliase auf 123 Betrieben; 83 Original-Monatsrechnungs-PDFs 2019–2026 in den Storage geladen + Regenerier-Sperre v0.72.4; MWST-Stand geklärt: Q4/2025 eingereicht, Berichtigung 2025 = 1'508.62 rappengenau, Q1+Q2/2026 Frist Ende August) (v0.64.0: **echte Strassenroute in der Tages-Karte** — der neue `TagesrouteService` holt den gefahrenen Verlauf bei OSRM (GeoJSON) statt Luftlinien quer über Berge und Seen; die Karte ist sofort mit der Luftlinie da und schärft nach, bei fehlender Autoroute oder ohne Netz bleibt die Luftlinie dünner und blasser stehen. v0.63.0: **Routen-Optimierung** im Tagesplan (Nächster-Nachbar + 2-opt, Termin-Anker bleiben fix, kann nie verschlechtern), neuer Screen **Auswertung Arbeitstage** (km/Stunden/Besuche je Monat, getrennte Nenner je Kennzahl), **Pause-Knopf** in der Arbeitstag-Karte (Migration 159, Tagessumme + laufende Pause + Wegpunkt-Stempel). v0.62.0: **OpenStreetMap als dritter Kartenhintergrund und neuer Standard** — swisstopo-Karte und Luftbild bleiben; Quellenangabe folgt dem gewählten Dienst; Event-Stände-Karte bleibt auf Luftbild. Google Maps als Hintergrund ist lizenzrechtlich ausgeschlossen (Kacheln nur mit Google-Renderer). v0.61.0: **Störungen/Pausen verderben die Fahrzeit-Lernkurve nicht mehr** — 23 % der beobachteten Werte lagen über 2× der echten Route, Ø 43 min zu viel. Neu ein Routing-Referenzwert je Betriebspaar (Migration 158, 2'882 Werte per OSRM-Matrix), `lueckePlausibel()` lernt nur im Fenster 0,5×–2×, 652 verdorbene Altwerte bereinigt (Rollback vorhanden). v0.60.1: neue Betriebe bekommen ihre Anfahrtszeiten ab Domat/Ems und Chur automatisch beim Speichern — Edge-Function `anfahrt-google` rechnet neu auch Einzelbetriebe und hat OSRM als kostenlosen Rückfall. v0.60.0 **Grundsatzfund**: Störungen und Montagen liessen sich gar nicht planen — beide Formulare schrieben den Status hart auf erledigt, weshalb alle 1'106 Störungen «behoben» und alle 809 Montagen «abgeschlossen» sind und der Tourenplan nie einen Eintrag fand. Neu: Schalter «Erst geplant» in beiden Formularen (Wegpunkt-Stempel nur bei erledigten Einsätzen), gemeinsame Helfer `stoerungOffen`/`montageOffen`. Dazu: Ein Tag mit erfasstem Feierabend gilt als abgeschlossen und wird statisch mit den Ist-Zeiten gezeigt, statt den Rest-Plan hinter «jetzt» zu schieben. v0.59.0: Servicezeiten + Ruhetage direkt am Tagesplan-Block, Warnung nennt den konkreten Grund (Ruhetag/Betriebsferien bis .../Zwischensaison), neue Warnung «Termin verpasst» wenn ein Anker vor der geplanten Ankunft liegt. v0.58.1: **Anfahrtszeit-Bug behoben** — Sonne Seehotel Eich zeigte 346 statt 117 min; die Heuristik war an Bergstrecken kalibriert und skalierte nicht (Median-Fehler über 100 km: 249 min). Umwegfaktor und Schnitt laufen jetzt distanzabhängig (2.20→1.45 / 32→78 km/h), kalibriert an 804 echten Routen: Median-Fehler 7 statt 35 min; Rüstzuschlag additiv 5 min; Anfahrt/Heimweg nehmen primär die gerechneten `anfahrtszeiten`-Werte, Startort per GPS erkannt. Migration 157 hält Google- und OSRM-Werte nebeneinander, Edge-Function `anfahrt-google` wartet auf Aktivierung der Routes API. v0.58.0: neuer **Aufgaben-Screen** als Kachel — anstehende Arbeiten chronologisch: eigene Aufgaben, offene Störungen, geplante Montagen, Eröffnungs-/Endreinigungen; Events in die Liste unten verschoben; Migration 156 `anfahrtszeiten` mit 804 OSRM-Routen von beiden Startorten zu allen Betrieben als Grundlage der Routen-Optimierung; v0.56.1: vergangene Tage mit gemessenen Ist-Zeiten; v0.56.2: Betriebsseite aus dem Block-Sheet verlinkt, fällige Geschwister-Anlagen bei Plan-Übernahme/Bulk ergänzt — Sunset-Fall, Arbeitstag-Fehleingaben-Schutz; v0.56.3: Startbildschirm kompakt ohne Scrollen; **v0.57.0 Nachtpaket 31.07.**: vergangene Tage zeigen die TATSÄCHLICHEN Reinigungen statt gespeicherter Pläne — readonly-Zeitachse, Tap öffnet die Reinigung; Plan-Übernahme lädt die echten Reinigungen des Quelltags ohne Störungen/Montagen; neue **Tages-Karte** (map-Icon im Tagesplan-Header): nummerierte Besuchs-Marker + Wegpunkt-Stempel auf swisstopo, zeitlich verbundene Linie, aussagekräftig ab 31.07.; GPS mit bis zu 3 Messungen, genaueste gewinnt — Openair-Befund; alle 16 Test-Tagespläne gelöscht, Arbeitstag-Daten 30.07. erhalten)
